  ...
  return (
    ...
    >
      <div className="bg-white p-5 rounded">
        ...
        <p>Welcome to instantyoutubevideodownloader!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of youtube downloader Website, located at
          instantyoutubevideodownloader.xyz.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use instantyoutubevideodownloader if
        ...
        <p>
          Unless otherwise stated, youtube downloader and/or its licensors own
          the intellectual property rights for all material on
          instantyoutubevideodownloader. All intellectual property rights are
          reserved. You may access this from instantyoutubevideodownloader for
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from instantyoutubevideodownloader</li>
          <li>
        ...
        <p>
          ...
          youtube downloader does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of youtube downloader,its agents and/or affiliates.
          ...
          youtube downloader shall not be liable for the Comments or for any
        ...
        <p>
          youtube downloader reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant youtube downloader a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of youtube downloader; and (d)
        ...
        <p>
          ...
          sending an e-mail to youtube downloader. Please include your name,
