  ...
  return (
    ...
    >
      <div className="bg-white p-5 rounded">
        <h1>Privacy Policy for youtube downloader</h1>

        <p>
          At instantyoutubevideodownloader, accessible from
          instantyoutubevideodownloader.xyz, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types
          of information that is collected and recorded by
          instantyoutubevideodownloader and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in instantyoutubevideodownloader. This policy is
        ...
        <p>
          ...
          advertising partners of instantyoutubevideodownloader.
        </p>
        ...
        <p>
          Note that instantyoutubevideodownloader has no access to or control
        ...
        <p>
          instantyoutubevideodownloader Privacy Policy does not apply to other
        ...
        <p>
          Request that a business that collects a consumer personal data
        ...
        <p>
          instantyoutubevideodownloader does not knowingly collect any Personal
